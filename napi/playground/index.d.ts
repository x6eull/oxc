...
export declare class Oxc {
  ...
  constructor(ast: undefined, astJson: string, ir: string, controlFlowGraph: string, scopeText: string, codegenText: string, codegenSourcemapText?: string, formattedText: string, prettierFormattedText: string, prettierIrText: string)
